...
*             : Dec. 17,2019 Rev.1.01.00    Deleted "Directory Configuration"
*                                           Modified "2.System Verification"
*                                           Modified "3. About Sample Code"
*                                           Modified "5. Operational Procedure"
*             : Mar. 25,2020 Rev.1.02.00    Update to e2 studio version 7.7
*             : Jun. 30,2020 Rev.1.03.00    Update to e2 studio version 7.8
*                                           Modified "3. About Sample Code"
*                                           Modified "5. Operational Procedure"
*             : Sep. 30,2020 Rev.1.04.00    Updated to e2 studio 2020-07
*             : Apr. 20,2021 Rev.1.05.00    Updated to e2 studio 2021-04
*******************************************************************************/
...
5. Operational Procedure
  ...
  (4) Building application program
  ...
  (6) Downloading sample code
    ...
    Select the debug configuration ["Project name" HardwareDebug] of the application program, 
