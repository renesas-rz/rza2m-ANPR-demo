...
*******************************************************************************/
/*******************************************************************************
 * File Name    : r_drp_lrgb2l_gaussian_blur.h
 * Description  : This source code is the header file of R_DRP_LRGB2L_GAUSSIAN_BLUR processing.
 ******************************************************************************/
#ifndef R_DRP_LRGB2L_GAUSSIAN_BLUR_H
#define R_DRP_LRGB2L_GAUSSIAN_BLUR_H
...
} r_drp_lrgb2l_gaussian_blur_t;

#endif /* R_DRP_LRGB2L_GAUSSIAN_BLUR_H */
