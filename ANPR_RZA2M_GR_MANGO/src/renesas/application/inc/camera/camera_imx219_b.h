...
/* VIN capture setting */
#ifdef CAM_VIN_PRECLIP_Y_416
  #define     CAM_VIN_PRECLIP_START_Y  ( 32u)               /* Start line  of pre clip area */
  #define     CAM_VIN_PRECLIP_WIDTH_Y  (416u)               /* Line width of pre clip area reduced to 416 lines*/
#else
...
/* Binning */
#define     CAM_BINNING_ENABLE       (1)                    /* 0-disable 2x2 binning 1-enable 2x2 binning 2-enable 4x4 binning*/
