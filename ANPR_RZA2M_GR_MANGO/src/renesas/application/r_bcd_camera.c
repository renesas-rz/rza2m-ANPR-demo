...
uint8_t R_BCD_CameraBayerMode = 0 ;
...
// Syncronization on Field (#define  SYNFIELD) on Line (//#define  SYNFIELD)
#define  SYNFIELD
...
int32_t R_BCD_CameraInit(void)
{
    ...
    /* get the bayer mode of camera module */
    R_BCD_CameraBayerMode = getBayerMode() ;
