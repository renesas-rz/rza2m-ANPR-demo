...
***********************************************************************************************************************/
void padding(TPrecision *__restrict__ dData, TPrecision *__restrict__ dPad, TsInt *__restrict__ iShapes)
{
...
* Return Value : no return value
***********************************************************************************************************************/
void avgpool_padding(TPrecision *__restrict__ dData, TPrecision *__restrict__ dPad, TsInt *__restrict__ iShapes)
{
	TsInt iD1,iD2,iD3,iD4;
	TsInt iN = iShapes[0];		// Number of examples
	TsInt iC = iShapes[1];		// Number of channels
...
* Return Value : no return value
***********************************************************************************************************************/
void convolution_without_pad(TPrecision *__restrict__ dData,const TPrecision *__restrict__ dWeights,const TPrecision *__restrict__ dBiases,TPrecision *__restrict__ dOut,TsInt *__restrict__ iShapes,TsInt *__restrict__ errorcode){
...
* Return Value : no return value
***********************************************************************************************************************/
void average_pooling_without_pad(TPrecision *__restrict__ dData, TPrecision *__restrict__ dOut, TsInt *__restrict__ iShapes)
{
...
* Return Value : no return value
***********************************************************************************************************************/
void max_pooling_without_pad(TPrecision *__restrict__ dData, TPrecision *__restrict__ dOut, TsInt *__restrict__ iShapes)
{
	TsInt sD1,sD2,sD3,sD4;			// Array dimension
	TsInt sInnerItr,sOuterItr,sOffset;
	TsInt iN = iShapes[0];
...
* Return Value : no return value
***********************************************************************************************************************/
void pooling_without_pad(TPrecision *__restrict__ dData, TPrecision *__restrict__ dOut, TsInt *__restrict__ iShapes)
{
...
* Return Value : no return value
***********************************************************************************************************************/
void innerproduct(TPrecision *__restrict__ data,const TPrecision *__restrict__ weights,const TPrecision *__restrict__ biases,TPrecision *__restrict__ out,TsInt *__restrict__ shapes,TsInt *__restrict__ errorcode){
	TsInt iRow, iColumn;
	TsInt iInneritr;
	TsInt N = shapes[0];
	TsInt D = shapes[1];
...
* Return Value : no return value
***********************************************************************************************************************/
void softmax(TPrecision *__restrict__ dData, TPrecision *__restrict__ dOut, TsInt iShapes )
{
